...
class PhoneNumber : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationCompleted(credential: PhoneAuthCredential) {
                ...
                finish()
                Log.d("PhoneNumberVerification" , "onVerificationCompleted Success")
            }

            // Called when verification is failed add log statement to see the exception
            override fun onVerificationFailed(e: FirebaseException) {
                Log.d("PhoneNumberVerification" , "onVerificationFailed  $e")
            }
            ...
            override fun onCodeSent(
                ...
                Log.d("PhoneNumberVerification","onCodeSent: $verificationId")
    ...
    private fun login() {
        number = findViewById<EditText>(R.id.phonesNumbers).text.trim().toString()
